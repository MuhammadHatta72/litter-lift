        ...
        <div class="mx-auto bg-white p-4 shadow  flex-col justify-center items-center w-96 dark:bg-gray-800 rounded-lg">
            ...
            <form method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" id="name" class="input" placeholder="Name" name="name" required
                        autofocus>
                </div>
                <div class="mb-6">
                    <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Email</label>
                    <input type="email" id="email" class="input" placeholder="user@gmail.com" name="email"
                        required>
                </div>
                ...
                <div class="mb-6" x-data="{ show: true }">
                    ...
                    <div class="relative">
                        <input :type="show ? 'password' : 'text'" name="confirm_password" id="confirm_password"
