        ...
        <div class="w-full mt-4">
            <div class="md:flex">
                <div class="md:w-2/3 px-6 pt-4 pb-8 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    <h3 class="text-gray-600 dark:text-gray-200 mb-3">Profil pengguna dari aplikasi litter lift</h3>
                    <div class="grid gap-6 mb-6 md:grid-cols-1">
                        ...
                        <div>
                            ...
                            <h2 class="block mb-2 text-base text-gray-500 dark:text-white">{{auth()->user()->address}}</h2>
                        </div>
                        <div>
                    ...
                    <a href="{{ url('/profile/'.auth()->user()->id.'/edit') }}" class="text-gray-100 bg-[#22A699] border border-gray-300 focus:outline-none hover:bg-[#22A699] focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-[#22A699] dark:text-gray-100 dark:border-gray-600 dark:hover:bg-[#22A699] dark:hover:border-gray-600 dark:focus:ring-gray-700">Edit Profile</a>
                </div>
                ...
                <div class="md:w-1/3 md:ml-3 mt-3 md:mt-0">
                    <div class="p-3 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <img class="w-full h-full mt-3" src="{{ url('./assets/image_users/'.auth()->user()->photo) }}" alt="user photo">
                        <form action="/profile/{{auth()->user()->id}}" method="post">
                            @csrf
                            @method('delete')
                            <button type="submit" class="w-full text-white bg-[#F24C3D] hover:bg-[#d63325] focus:ring-4 focus:outline-none focus:ring-[#d63325] font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex justify-center items-center mr-2 dark:bg-[#F24C3D] dark:hover:bg-[#d63325] dark:focus:ring-[#d63325] my-3" onclick="return confirm('Apakah yakin ingin menghapus foto profil?')">
