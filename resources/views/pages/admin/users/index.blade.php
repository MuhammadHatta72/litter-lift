...
<div class="px-4 pt-8 pb-3 sm:ml-64">
    <div class="mt-12 mr-3">
        ...
        @can('isAdmin')
        <h2 class="text-2xl text-gray-800 dark:text-gray-100 mt-4">Daftar Pengguna</h2>
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex justify-start">
                                    <a href="{{ url('users/'.$user->id)}}" class="text-white bg-[#22A699] hover:bg-[#108276] focus:ring-4 focus:outline-none focus:ring-[#22A699] font-medium rounded-full text-sm p-2 text-center inline-flex items-center mr-1 dark:bg-[#22A699] dark:hover:bg-[#108276] dark:focus:ring-[#108276]">
                                    ...
                                    <a href="{{ url('users/'.$user->id.'/edit')}}" class="text-white bg-[#F2BE22] hover:bg-[#d3a008] focus:ring-4 focus:outline-none focus:ring-[#F2BE22] font-medium rounded-full text-sm p-2 text-center inline-flex items-center mr-1 dark:bg-[#F2BE22] dark:hover:bg-[#d3a008] dark:focus:ring-[#d3a008]">
                                        <svg fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" class="w-4 h-4">
