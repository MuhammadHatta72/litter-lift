                    ...
                    <tbody>
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                <span class="bg-yellow-100 text-yellow-800 text-xs font-medium mr-2 px-2.5 py-1 rounded-xl dark:bg-yellow-900 dark:text-yellow-300">{{$swap_trash->total_weight}} Gram</span>
                            </th>
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex justify-start">
                                    <a href="{{ url('swap-trash-user/'. $swap_trash->id)}}" class="text-white bg-[#22A699] hover:bg-[#108276] focus:ring-4 focus:outline-none focus:ring-[#22A699] font-medium rounded-full text-sm p-2 text-center inline-flex items-center mr-1 dark:bg-[#22A699] dark:hover:bg-[#108276] dark:focus:ring-[#108276]">
